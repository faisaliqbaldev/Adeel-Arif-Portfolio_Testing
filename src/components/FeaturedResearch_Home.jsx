    ...
    <section className="bg-surface-ivory pt-section-gap" id="research">
          <div className="max-w-container-max mx-auto px-margin-phone md:px-margin-desktop">
            <div className="flex flex-col md:flex-row justify-between items-baseline mb-6 border-b border-border-subtle pb-4">
              <h2 className="text-label font-ui text-secondary uppercase tracking-[0.08em]">
                Featured Research
              </h2>
               <a
                className="hidden md:flex text-secondary font-ui text-ui hover:text-primary transition-colors items-center gap-1 group mt-4 md:mt-0"
                href="#"
              >
            ...
            <div className="grid md:grid-cols-3 gap-gutter">
              ...
              <div className="border-b border-border-subtle pb-6 group cursor-pointer hover:bg-surface transition-colors p-4 -mx-4 rounded-DEFAULT">
                <p className="text-label font-ui text-text-muted mb-2">
                  2023 · Robotics Journal
                </p>
                <h3 className="text-card-heading font-display text-primary mb-3 group-hover:text-secondary transition-colors">
                  Finite-time tracking control for robotic manipulators
                </h3>
                <p className="text-body font-body text-text-muted line-clamp-3">
            ...
            <a
                className="md:hidden text-secondary font-ui text-ui hover:text-primary transition-colors inline-flex items-center gap-1 group mt-4 md:mt-0"
                href="#"
              >
                View all publications
                <span className="material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform">
